...
namespace Ordering.Infrastructure.Extensions
{
    internal class InitialData
    {
        public static IEnumerable<Customer> Customers =>
            [
            Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "customer1", "customer1@gmail.com"),
            Customer.Create(CustomerId.Of(new Guid("189dc8dc-990f-48e0-a37b-e6f2b60b9d7d")), "customer2", "customer2@gmail.com")
            ];
        ...
        public static IEnumerable<Order> OrdersWithItems
        {
            get
            {
                var address1 = Address.Of("customer1", "Lastname", "customer1@gmail.com", "Bahcelievler No:4", "Turkey", "Istanbul", "38050");
                var address2 = Address.Of("customer2", "Lastname", "customer2@gmail.com", "Broadway No:1", "England", "Nottingham", "08050");
